...
select codigo, substring(nif, 1, 8) as digitos_nif, substring(nif, 9, 1) as letra_nif from empleado;
...
select e.*, d.* from empleado e join departamento d on e.codigo_departamento = d.codigo order by d.nombre, e.apellido1, e.apellido2, e.nombre;
...
select d.nombre from departamento d join empleado e on d.codigo = e.codigo_departamento where e.nif = '38382980M';

-- 6. Devuelve el nombre del departamento donde trabaja el empleado Pepe Ruiz Santana.
select d.nombre from departamento d join empleado e on d.codigo = e.codigo_departamento where e.nombre = 'Pepe' and e.apellido1 = 'Ruiz' and e.apellido2 = 'Santana';

-- 7. Devuelve un listado con los datos de los empleados que trabajan en el departamento de I+D. Ordena el resultado alfabéticamente.
select e.* from empleado e join departamento d on e.codigo_departamento = d.codigo where d.nombre = 'I+D' order by e.apellido1, e.apellido2, e.nombre;

-- 8. Devuelve un listado con los datos de los empleados que trabajan en el departamento de Sistemas, Contabilidad o I+D. Ordena el resultado alfabéticamente.
select e.* from empleado e join departamento d on e.codigo_departamento = d.codigo where d.nombre in ('Sistemas', 'Contabilidad', 'I+D') order by e.apellido1, e.apellido2, e.nombre;

-- 9. Devuelve una lista con el nombre de los empleados que tienen los departamentos que no tienen un presupuesto entre 100000 y 200000 euros.
select e.nombre from empleado e join departamento d on e.codigo_departamento = d.codigo where d.presupuesto < 100000 or d.presupuesto > 200000;

-- 10. Devuelve un listado con el nombre de los departamentos donde existe algún empleado cuyo segundo apellido sea NULL. Tenga en cuenta que no debe mostrar nombres de departamentos que estén repetidos.
select distinct d.nombre from departamento d join empleado e on d.codigo = e.codigo_departamento where e.apellido2 is null;
...
select e.*, d.* from empleado e left join departamento d on e.codigo_departamento = d.codigo;

-- 2. Devuelve un listado donde sólo aparezcan aquellos empleados que no tienen ningún departamento asociado.
select e.* from empleado e left join departamento d on e.codigo_departamento = d.codigo where d.codigo is null;

-- 3. Devuelve un listado donde sólo aparezcan aquellos departamentos que no tienen ningún empleado asociado.
select d.* from departamento d left join empleado e on d.codigo = e.codigo_departamento where e.codigo_departamento is null;

-- 4. Devuelve un listado con todos los empleados junto con los datos de los departamentos donde trabajan. El listado debe incluir los empleados que no tienen ningún departamento asociado y los departamentos que no tienen ningún empleado asociado. Ordene el listado alfabéticamente por el nombre del departamento.
select e.*, d.* from empleado e right join departamento d on e.codigo_departamento = d.codigo union select e.*, d.* from empleado e left join departamento d on e.codigo_departamento = d.codigo order by d.nombre;
...
select e.*, d.* from empleado e right join departamento d on e.codigo_departamento = d.codigo where e.codigo_departamento is null union select e.*, d.* from empleado e left join departamento d on e.codigo_departamento = d.codigo where d.codigo is null order by d.nombre;
...
select count(*) as empleados_con_apellido2 from empleado where apellido2 is not null;
...
select d.nombre, count(e.codigo) as num_empleados from departamento d left join empleado e on d.codigo = e.codigo_departamento group by d.nombre;
...
select d.nombre, count(e.codigo) as num_empleados from departamento d left join empleado e on d.codigo = e.codigo_departamento group by d.nombre having count(e.codigo) > 2;
...
select d.nombre, count(e.codigo) as num_empleados from departamento d left join empleado e on d.codigo = e.codigo_departamento where d.presupuesto > 200000 group by d.nombre;
...
select nombre from departamento where codigo not in (select codigo_departamento from empleado);

-- Subconsultas con EXISTS y NOT EXISTS
-- 10. Devuelve los nombres de los departamentos que tienen empleados asociados. (Utilizando EXISTS o NOT EXISTS).
select nombre from departamento where exists (select 1 from empleado where departamento.codigo = empleado.codigo_departamento);

-- 11. Devuelve los nombres de los departamentos que tienen empleados asociados. (Utilizando EXISTS o NOT EXISTS).
select nombre from departamento where not exists (select 1 from empleado where departamento.codigo = empleado.codigo_departamento);
